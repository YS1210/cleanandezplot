...
a)  Briefly describe in one - two sentences what your R package does and
  ...
  > Our R package cleanandezplot provides simple tools to automatically clean        missing  values and quickly generate commonly used plots such as                 histograms, scatter plots, and bar charts. 
...
b)  To make installation easier, your R package should be in a public
    ...
    `https://github.com/YS1210/cleanandezplot`
...
```{r}
Sys.setenv(LANG = "en")
remotes::install_github("YS1210/cleanandezplot")
```
